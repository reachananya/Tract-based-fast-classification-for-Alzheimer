...
for subject_id in subject_fol:
    class_mat = np.load(f'/content/drive/MyDrive/Ananya_Singhal_2010110087/ICIP - classification/21diff/ClassMatrices_ultra_5bins_21diff_pred/class_matrix_FA_21diff_{subject_id}.npy')
    class_matrix_AD = np.load(f'/content/drive/MyDrive/Ananya_Singhal_2010110087/ICIP - classification/21diff/ClassMatrices_ultra_5bins_21diff_pred/class_matrix_AD_21diff_{subject_id}.npy')
...
for i, (train_index, test_index) in enumerate(kf.split(X)):
  ...
  model_svm = SVC(kernel='rbf', C=2.0, probability=True, random_state=42, degree=2)
